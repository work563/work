...
def recommend_hairstyle(face_shape):
    suggestions = {
        "Oval": ["Layered Cut", "Side Bangs", "Wavy Bob"],
        "Round": ["Long Layers", "High Volume Top", "Side Part"],
        "Square": ["Soft Curls", "Side Swept", "Layered Bob"]
    }
    return suggestions.get(face_shape, ["Classic Cut"])
...
if uploaded_file is not None:
    ...
    for style in recommend_hairstyle(face_shape):
        st.write(f"👉 {style}")
